...
import p4_group_8_repo.Game_actor.Background_Image;
import p4_group_8_repo.Game_actor.Digit;
import p4_group_8_repo.Game_actor.End;
import p4_group_8_repo.Game_actor.Level_title;
import p4_group_8_repo.Game_actor.Long_log;
import p4_group_8_repo.Game_actor.Score_title;
...
import p4_group_8_repo.Game_button.Pause_butt;
import p4_group_8_repo.Game_button.Resume_butt;
import p4_group_8_repo.Game_highscore.HighScore_list_butt;
...
public class Create_animations {
	...
	public Create_animations(MyStage background) {
		...
		//Button
		Resume_butt resume_butt = new Resume_butt(background, 70, 30, 7);
	    Pause_butt pause_butt = new Pause_butt(background, 70, 31, 43);
